 ...
 * Plugin URI: http://plugins.zartoshtsepideman.com/sepideman-persian-fonts
...
function register_mysettings(){
	...
	register_setting( 'sepideman-settings', 'mitra' );
}
...
function sepideman_persian_fonts_options() {
	...
	echo '<tr><td>میترا : </td><td><textarea style="width: 100%" dir="ltr" type="text" name="mitra" >' . esc_attr( get_option('mitra') ) . '</textarea></td></tr></table>';
	submit_button();
	echo '</form>';
...
function sepideman_persian_fonts() {
	...
	echo '<script>jQuery(document).ready(function(){jQuery("' . esc_attr( get_option('mitra') ) . '").css({ "font-family" : "mitra" });});</script>';
}
